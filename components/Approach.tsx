    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-black w-full gap-4 mx-auto ">
        ...
        icon={<AceternityIcon order='phase 2'/> }
         description="Once we agree on the plan, i cue my sportify playlist and dive into coding. from initial sketches to polished code, I keep you updated every step of the way."
         >
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center  dark:border-white/[0.2] rounded-3xl  max-w-sm w-full mx-auto p-4 lg:h-[30rem] relative"
    >
      ...
      <div className="relative z-20">
        <div className="text-center absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
